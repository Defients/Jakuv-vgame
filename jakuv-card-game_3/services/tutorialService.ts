    ...
    switch (action.type) {
        case 'cardClick':
            ...
            if (draft.actionState === ActionState.AWAITING_SCUTTLE_TARGET) {
                ...
                if (stolenCardResult) {
                    draft.effectContext = { type: 'JACK_STEAL', stolenCard: {...stolenCardResult.card}, initiatorId: player.id };
                ...
                draft.effectContext = { type: 'SOFT_RESET', targetPlayerId: opponent.id, targetRow: 'scoreRow', discardedCards: [], initiatorId: player.id };
