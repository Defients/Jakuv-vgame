...
export enum ActionState {
  ...
  AWAITING_SWAP_HAND_CARD = 'AWAITING_SWAP_HAND_CARD',
  ...
  AWAITING_SOFT_RESET_DISCARD_CHOICE = 'AWAITING_SOFT_RESET_DISCARD_CHOICE',
  ...
  AWAITING_SWAP_PEEK_CONFIRMATION = 'AWAITING_SWAP_PEEK_CONFIRMATION',
}
...
export type EffectType = 
    | { type: 'JACK_STEAL', stolenCard: Card } 
    | { type: 'SOFT_RESET', targetPlayerId: string, targetRow: 'scoreRow' | 'royaltyRow', discardedCards: Card[] }
    | { type: 'INTERROGATOR_REVEAL', revealedFrom: string };
